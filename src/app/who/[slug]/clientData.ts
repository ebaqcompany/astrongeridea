...
export const productOrgPricing = [
  {
    ...
    description: "Improve existing products with targeted UX improvements",
    price: "$35K",
    discount: "$35K–$75K project-based",
    features: [
      "UX audit and opportunity analysis",
  ...
  },
  {
    ...
    description: "Strategic redesign of legacy systems and platforms",
    price: "$75K",
    discount: "$75K–$200K+ phased engagement",
    features: [
      "Legacy system UX assessment",
  ...
  },
  {
    ...
    description: "Build and scale your design capabilities",
    price: "$12K",
    discount: "$12K–$20K/month retainer",
    features: [
      "Design operations frameworks",
...
export const agencyPricing = [
  {
    ...
    description: "Production-ready design under your brand",
    price: "$7K",
    discount: "$7K–$15K/month",
    features: [
  ...
  },
  {
    ...
    description: "Senior designers embedded in your team",
    price: "$7K",
    discount: "$7K–$18K+/month",
    features: [
      "Senior-level design talent",
      "Seamless team integration",
      "Your tools, your process",
      "Scalable hours and commitment",
  ...
  },
  {
    ...
    description: "Deep collaboration on complex client projects",
    price: "Custom",
    discount: "Tailored to engagement scope",
    features: [
      "Joint pitching and proposals",
      "Shared project ownership",
      "Strategic UX and product design",
  ...
  },
  {
    ...
    description: "Validate concepts and inform strategy",
    price: "$8.5K",
    discount: "$8.5K–$25K per engagement",
    features: [
      "User research and testing",
