...
export const Navbar2Defaults: Props = {
  ...
  navLinks: [
    ...
    { title: "Case Studies", url: "/case-studies" },
    {
      ...
      url: "#",
      subMenuLinks: [
        { title: "Product Strategy", url: "/services/product-strategy" },
        { title: "Product UX Design", url: "/services/product-ux-design" },
        { title: "Design Systems", url: "/services/design-systems" },
        { title: "AI Product Design", url: "/services/ai-product-design" },
        { title: "Fractional Leadership", url: "/services/fractional-design-leadership" },
      ],
    },
