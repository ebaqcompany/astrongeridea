...
export const Portfolio11Defaults: Props = {
  ...
  projects: [
    {
      ...project,
      title: "Estate Guru: Financial Advisor Dashboard",
      image: { src: "/assets/poster-case-study-estateguru.jpg", alt: "EstateGuru Dashboard" },
    },
    {
      ...project,
      title: "Flowbird: Park Detroit",
      image: { src: "/assets/poster-case-study-flowbird.jpg", alt: "Flowbird Park Detroit" },
    },
    {
      ...project,
      title: "Euvic: Financial Dashboard",
      image: { src: "/assets/poster-case-study-euvic.jpg", alt: "Euvic Financial Dashboard" },
    },
  ],
  button: {
    title: "View all",
